...
abstract class AppButton extends StatelessWidget {
  ...
  EdgeInsetsGeometry? getUsingPadding(BuildContext context) {
    final double start =
        paddingStart ?? paddingHorizontal ?? paddingAll ?? padding?.start ?? 0;
    final double top =
        paddingTop ?? paddingVertical ?? paddingAll ?? padding?.top ?? 0;
    final double end =
        paddingEnd ?? paddingHorizontal ?? paddingAll ?? padding?.end ?? 0;
    final double bottom =
        paddingBottom ?? paddingVertical ?? paddingAll ?? padding?.bottom ?? 0;
  ...
  /// 圆角
  BorderRadius? getUsingBorderRadius(BuildContext context) {
